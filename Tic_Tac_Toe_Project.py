#PFUN PROJECT 2021--------TIC-TAC-TOE GAME---------
#I ADDED THIS GUI TO OUR CODE USING HELP FROM THE INTERNET
from tkinter import *
...
while not (win):
    ...
    #HERE WE ARE CHECKING IF THE ROW AND COLUMN ENTERED BY PLAYER 1 ARE EMPTY OR NOT,
    #IF A PREVIOUS VALUE IS FOUND, WE'LL END THE GAME WITH AN ERROR MESSAGE
    if board[r][c] == " ":
        board[r][c] = turn[0]
    else:
        print("ERROR! You can't choose a box(row,col) which has already been taken "
              "by the other player. You are violating the game rules. We can no longer allow you to play")
        exit()
